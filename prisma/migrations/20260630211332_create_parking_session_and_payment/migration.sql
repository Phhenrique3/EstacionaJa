...
-- CreateIndex
CREATE UNIQUE INDEX "Payment_parkingSessionId_key" ON "Payment"("parkingSessionId");
...
-- AddForeignKey
ALTER TABLE "Payment" ADD CONSTRAINT "Payment_parkingSessionId_fkey" FOREIGN KEY ("parkingSessionId") REFERENCES "ParkingSession"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
